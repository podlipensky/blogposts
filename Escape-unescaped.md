...
2. You can create a function with arbitrary code by passing it into `Function` constructor. So once we constructed string `alert(1)` (by using an approach above) we can write
```
Function(‘alert(1)’)()
```
